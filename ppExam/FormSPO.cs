...
namespace ppExam
{
    public partial class FormSPO : Form
    {
        ...
        private void FormSPO_Load(object sender, EventArgs e)
        {
            CreateColumns();
        ...
        public void RefreshGridView(DataGridView gridView)
        {
            ...
            gridView.Rows.Clear();
            string queryString = $"select * from spo";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            string query = $"insert into spo (name_prepa) values ('{name_prepa}')";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string query = $"DELETE FROM spo WHERE id_prepa = " + id;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string query = $"UPDATE spo SET name_prepa = '{name_prepa}' WHERE id_prepa = " + id;
            NpgsqlCommand command = new NpgsqlCommand(@query, dataBase.GetConnection());
            command.ExecuteNonQuery();
