...
namespace ppExam
{
    public partial class FormСпециа : Form
    {
        ...
        private void FormСпециа_Load(object sender, EventArgs e)
        {
            CreateColumns();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            string query = $"insert into specialty (name_prepa) values ('{name_prepa}')";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string query = $"DELETE FROM specialty WHERE id_prepa = " + id;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string query = $"UPDATE specialty SET name_prepa = '{name_prepa}' WHERE id_prepa = " + id;
            NpgsqlCommand command = new NpgsqlCommand(@query, dataBase.GetConnection());
            command.ExecuteNonQuery();
